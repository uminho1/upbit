...
while True:
    ...
    # 1st_price_value
    target_10 = target_10
    target_10_call = target_10 - (target_10 * 0.013)
    target_10_call_gap = target_10 * 0.013
    #====================================================================================================    
    # - sell value
    target_10 = target_10
    target_10_down = target_10 - (target_10 * 0.026)
    target_10_down_gap = target_10 * 0.026
    #====================================================================================================    
    # + 1.5% sell value
    ...
    if price < target_10 and price <= target_10_down:   
        ...
        count = 4
        target_10_call_4th = sell_price1 - (price * 0.01)
    ...
    print("▶ - sell : {0:,.0f}".format(target_10_down_gap))
    print("▶ + sell : {0:,.0f}".format(target_10_up))
    print("▶ sell Gap : {0:,.0f}".format(target_10_up_gap))
    print("▶ call Target : {0:,.0f}".format(target_10_call))
