...
while True:
    ...
    if coin_jango == 0 and jango > 6000 and int(stochrsiRSI_K) > 0 and int(macd[0]) < -180000 and -8000 < int(macd_gap) > 8000:
    ...
    if bay_no == 2 and int(stochrsiRSI_K) > 0 and int(macd[0]) < -220000 and -8000 < int(macd_gap) > 8000:
    ...
    if bay_no == 3 and int(stochrsiRSI_K) > 0 and int(macd[0]) < -270000 and -8000 < int(macd_gap) > 8000:
    ...
    elif sell_no == 1 and coin_price > coin_avg_price and coin_total_krw > 1 and int(stochrsiRSI_K) > 0 and int(macd[0]) > 150000 and int(macd_gap) > 50000:
    ...
    elif sell_no == 2 and coin_price > coin_avg_price and coin_total_krw > 1 and int(stochrsiRSI_K) > 0 and int(macd[0]) > 200000 and int(macd_gap) > 80000:
    ...
    elif sell_no == 3 and coin_price > coin_avg_price and coin_total_krw > 1 and int(stochrsiRSI_K) > 0 and int(macd[0]) > 250000 and int(macd_gap) > 100000:
    ...
    if time_hore > "091000" and time_hore < "091015":
        ...
        bot.sendMessage(chat_id=chat_id, text="stochRSI_K : {0:,.2f}".format(stochrsi_K.iloc[-1]*100))
        bot.sendMessage(chat_id=chat_id, text="현재가격: {0:,.0f}".format(coin_price))
        bot.sendMessage(chat_id=chat_id, text='MACD값이 -180,000이하 and MACD_Gap값이 -8,000 ~ 8,000이면 1차매수')
        bot.sendMessage(chat_id=chat_id, text='MACD값이 -220,000이하 and MACD_Gap값이 -8,000 ~ 8,000이면 2차매수')
        bot.sendMessage(chat_id=chat_id, text='MACD값이 -270,000이하 and MACD_Gap값이 -8,000 ~ 8,000이면 3차매수')
        bot.sendMessage(chat_id=chat_id, text='MACD값이 +150,000이상 and MACD_Gap값이 50,000이상이면 1차매도')
        bot.sendMessage(chat_id=chat_id, text='MACD값이 +200,000이상 and MACD_Gap값이 80,000이상이면 2차매도')
        bot.sendMessage(chat_id=chat_id, text='MACD값이 +250,000이상 and MACD_Gap값이 100,000이상이면 3차매도')
