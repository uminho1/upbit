...
while True:
    ...
    stochrsiRSI_K = '{0:,.3f}'.format(stochrsi_K.iloc[-1]*100)
    stochrsiRSI_D = '{0:,.3f}'.format(stochrsi_D.iloc[-1]*100)
    #------------------------------------------------------------------------
    ...
    print('------------------------------------------')
    print('stoch_rsi_K: ', stochrsiRSI_K)
    print('stoch_rsi_D: ', stochrsiRSI_D)
    print('------------------------------------------')
