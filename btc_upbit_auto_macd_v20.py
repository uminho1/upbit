...
while True:
    ...
    elif sell_no == 1 and stochrsiRSI_K > 80 and macd[0] > 115000 and macd_gap < 15000:
    ...
    if time_min > "0000" and time_min < "0015":
        ...
        bot.sendMessage(chat_id=chat_id, text='MACD값이 +115000이상 and MACD_Gap이 15000이하 and stochRSI_K값이 80이상이면 전량매도')
