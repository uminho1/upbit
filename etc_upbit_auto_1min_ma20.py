...
while True:
    ...
    upbit_target_call_2nd = upbit_target - (upbit_target * (0.45/100))
    ...
    #====================================================================================================
    # + sell value
    upbit_target_up_1st = krw_call_avg_price + (krw_call_avg_price * (0.35/100))
    upbit_target_up_2nd = krw_call_avg_price + (krw_call_avg_price * (0.50/100))
